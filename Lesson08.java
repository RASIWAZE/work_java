...
//		if (x.equals(" ")) {
//			return "1つ目の数値が入力されていません";
//		} else if(y.equals(" ")) {
//			return "2つ目の数値が入力されていません";
//		} else if(z.equals(" ")) {
//			return "最後の数値が入力されていません";
//		}
		...
		//intNumsに引数をint型に変換して代入、正しく数値に変換されなかった場合は「数値でない値が入力されています」と出力
		for(int i = 0; i < 3; i++) {
			try {
...
//		} catch (NumberFormatException e){
//			return "1つ目に入力されたのが数値ではありません";
//		}
//		
//		try {
//			intY = Integer.parseInt(y);
//		} catch (NumberFormatException e){
//			return "2つ目に入力されたのが数値ではありません";
//		}
//		
//		try {
//			intZ = Integer.parseInt(z);
//		} catch (NumberFormatException e){
//			return "最後に入力されたのが数値ではありません";
//		}
