...
public class Lesson07 {
	...
	public static void main(String[] args) {
		...
		//personに格納されたHashMap<String, String>のキーと値のセットをnameAndAgeに代入
		for(HashMap.Entry<String, String> nameAndAge : person.entrySet()) {
			
			//nameAndAgeに代入されているキーと値をそれぞれ.getKey()と.getValue()で取得して文字列とともに出力
			System.out.println("[name => '" + nameAndAge.getKey() + "', 'age' => '" + nameAndAge.getValue() + "']");
		}
	}
}
